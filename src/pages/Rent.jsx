  ...
  const fetchRentalProperties = async () => {
    try {
      ...
      const q = query(
        ...
        where("listingType", "in", ["rent", "Rent", "RENT"])
      );
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 py-20 px-4 text-center">
        ...
        >
          Discover luxury homes and apartments available for rent
        </motion.p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-end mb-6">
          <motion.button
            ...
            className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition border border-gray-700"
          >
